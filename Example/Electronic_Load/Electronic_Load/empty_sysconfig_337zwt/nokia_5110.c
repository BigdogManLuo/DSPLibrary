...
//：
    {0x0000,0x0000,0x3000,0x3000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0300,0x0300,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000},
//阻
    {0xFE00,0x0200,0x3200,0xCE00,0x0000,0xFE00,0x9200,0x9200,0x9200,0xFE00,0x0000,0x0000,0x0F00,0x0200,0x0200,0x0100,0x0800,0x0F00,0x0800,0x0800,0x0800,0x0F00,0x0800,0x0000},
//性
    {0x7800,0x0000,0xFF00,0x0800,0x2000,0x9C00,0x8800,0xFF00,0x8800,0x8800,0x0000,0x0000,0x0000,0x0000,0x0F00,0x0000,0x0800,0x0800,0x0800,0x0F00,0x0800,0x0800,0x0800,0x0000},
//容
    {0x4600,0x4200,0xAA00,0xA600,0x9200,0x8B00,0x9200,0xA600,0xAA00,0x4200,0x4600,0x0000,0x0000,0x0000,0x0F00,0x0400,0x0400,0x0400,0x0400,0x0400,0x0F00,0x0000,0x0000,0x0000},
//性
    {0x7800,0x0000,0xFF00,0x0800,0x2000,0x9C00,0x8800,0xFF00,0x8800,0x8800,0x0000,0x0000,0x0000,0x0000,0x0F00,0x0000,0x0800,0x0800,0x0800,0x0F00,0x0800,0x0800,0x0800,0x0000},
//感
    {0x0000,0xFE00,0x0200,0xEA00,0xAA00,0xEA00,0x0200,0x9F00,0x6200,0x9B00,0xC200,0x0000,0x0900,0x0600,0x0000,0x0600,0x0800,0x0A00,0x0D00,0x0800,0x0C00,0x0200,0x0D00,0x0000},
//性
    {0x7800,0x0000,0xFF00,0x0800,0x2000,0x9C00,0x8800,0xFF00,0x8800,0x8800,0x0000,0x0000,0x0000,0x0000,0x0F00,0x0000,0x0800,0x0800,0x0800,0x0F00,0x0800,0x0800,0x0800,0x0000}
...
void show_statusofLoad(unsigned int index,float PF,int CenterIndex)
{
    //通过index判断当前输入是感性还是容性
    unsigned int  status;
    if(index>CenterIndex)//如果是容性
    {
        status=1;
    }
    else if(index<CenterIndex)//如果是感性
    {
        status=2;
    }
    ...
    {
    case 1:
        LCD_write_chinese_string(0,0,12,2,28,1);
        break;
    case 2:
        LCD_write_chinese_string(0,0,12,2,26,1);
        break;
    case 3:
        LCD_write_chinese_string(0,0,12,2,24,1);
    default:
        break;
    }
    LCD_ShowFloat(0,2.8,pf,2,2);
}
